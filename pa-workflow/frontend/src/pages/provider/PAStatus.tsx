        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {paData.status === 'APPROVED' && paData.decision && (
            <Card className="border-green-200">
              <div className={`p-6 ${statusConfig.bgColor} border-l-4 border-green-500 rounded-lg`}>
                ...
                {paData.decision.authorizedQuantity && (
          ...
          {(paData.status === 'IN_REVIEW' || paData.status === 'ESCALATED') && (
            <Card className="border-blue-200">
              <div className={`p-6 ${statusConfig.bgColor} border-l-4 border-blue-500 rounded-lg`}>
                <div className="flex items-center mb-4">
                  <User className="w-8 h-8 text-blue-600 mr-3" />
                  <h3 className="text-xl font-bold text-blue-900">Under Clinical Review</h3>
                </div>
                  ...
                  {paData.scoringResult && (
                    <div className="mt-4 pt-4 border-t">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="font-semibold text-primary">{paData.scoringResult.confidence}%</span>
                      </div>
                    </div>
                  )}
                </div>
